...
DEFAULT_FROM_EMAIL = env(
    "DEFAULT_FROM_EMAIL",
    default="ShopStarter <noreply@shopstarter.com>"
)
...
FRONTEND_URL = env(
    "FRONTEND_URL",
    default="https://shopstarter.online"
)
...
REDIS_URL = (
    _get_env_stripped("REDIS_URL")
    or _get_env_stripped("REDIS_PRIVATE_URL")
)
...
CELERY_TASK_ALWAYS_EAGER = env.bool(
    "CELERY_ALWAYS_EAGER",
    default=DEBUG and not REDIS_URL
)
